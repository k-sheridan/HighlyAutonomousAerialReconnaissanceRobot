void drawGraphics() {
  ...
  if (mode == 1) {              //Direct control visualisation tab
  ...
  if (connected == true) {
    ...
    delta = (int)map(relAlt, 0, 200, 0, 100);  //SONAR DATA
    colorVal = relAlt * 0.010;
    visColor = lerpColor(color(255, 0, 0), color(0, 255, 0), colorVal);
    fill(visColor);
    rect(580, (610 + delta), 50, 5);
    textAlign(RIGHT);
    fill(255);
    text(relAlt, 577, (615 + delta));
    //----------------------------------------------------------------------------
  ...
  if (mode == 1) {
    image(y_on, 825, 7, 20, 20);
    image(y_off, 1045, 7, 20, 20);
    image(y_off, 1207, 7, 20, 20);
    image(y_off, 1330, 7, 20, 20);
  }
  if (mode == 2) {
    image(y_off, 825, 7, 20, 20);
    image(y_on, 1045, 7, 20, 20);
    image(y_off, 1207, 7, 20, 20);
    image(y_off, 1330, 7, 20, 20);
  }
  if (mode == 3) {
